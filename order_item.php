...
$query = mysqli_query($conn, "SELECT *, SUM(tb_daftar_menu.harga * tb_list_order.jumlah) AS harganya 
                              FROM tb_list_order 
                              LEFT JOIN tb_order ON tb_order.id_order = tb_list_order.kode_order 
                              LEFT JOIN tb_daftar_menu ON tb_daftar_menu.id = tb_list_order.menu 
                              LEFT JOIN tb_bayar ON tb_bayar.id_bayar = tb_order.id_order 
                              WHERE tb_list_order.kode_order = '".$_GET['order']."' 
...
<div class="col-lg-9 mt-2">
    <div class="card">
        ...
        <div class="card-body">
            <a href="order" class="btn custom-tambah-button mb-3"><i class="bi bi-arrow-left"></i></a>
            <div class="row">
                <div class="col-lg-3">
                ...
                <div class="modal-dialog modal-lg modal-fullscreen-md-down">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn custom-tambah-button" name="input_orderitem_validate"
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $row['jumlah'] ?>
                                                <!-- Corrected variable for quantity -->
                                            </td>
                                            <td>
                                                <?php
            if ($row['status']==1){
            ...
            ?>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn custom-cancel-button"
                                data-bs-dismiss="modal">Close</button>
                            <button type="submit" class="btn custom-order-button" name="bayar_validate"
