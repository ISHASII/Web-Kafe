...
$query = mysqli_query($conn, "SELECT tb_order.*, tb_bayar.*, nama, SUM(tb_daftar_menu.harga * tb_list_order.jumlah) AS harganya 
                              FROM tb_order 
                ...
                <div class="modal-dialog modal-lg modal-fullscreen-md-down">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn custom-tambah-button" name="input_order_validate"
                                value="12345">Buat
                                Order</button>
                        </div>
                        </form>
