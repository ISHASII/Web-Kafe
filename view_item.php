...
$query = mysqli_query($conn, "SELECT tb_list_order.*, 
    tb_daftar_menu.nama_menu, 
    tb_daftar_menu.harga AS harga_menu, 
    SUM(tb_list_order.jumlah * tb_daftar_menu.harga) AS harganya
    FROM tb_list_order
    LEFT JOIN tb_order ON tb_order.id_order = tb_list_order.kode_order
    LEFT JOIN tb_daftar_menu ON tb_daftar_menu.id = tb_list_order.menu
    LEFT JOIN tb_bayar ON tb_bayar.id_bayar = tb_order.id_order
    WHERE tb_list_order.kode_order = '$kode'
...
<div class="col-lg-9 mt-2">
    <div class="card">
        ...
        <div class="card-body">
            <a href="report" class="btn custom-tambah-button mb-3"><i class="bi bi-arrow-left"></i></a>
            <div class="row">
                <div class="col-lg-3">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo number_format($row['harga_menu'], 0, ',', '.') ?></td>
