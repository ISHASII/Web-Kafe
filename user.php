        ...
        <div class="card-body">
            <div class="row">
                <div class="col d-flex justify-content-end">
                    <button class="btn custom-tambah-button" data-bs-toggle="modal" data-bs-target="#ModalTambahUser">
                        Tambah User</button>
                </div>
            </div>
                                ...
                                <form action="">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input type="password" class="form-control" id="floatingInput"
                                                    placeholder="Password" enabled value="" name="password">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn custom-tambah-button"
                                            name="input_user_validate" value="12345">Save changes</button>
                                    </div>
                                </form>
                        </div>
                            ...
                            <form class="needs-validation" novalidate action="proses/proses_edit_user.php"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input
                                                <?php echo ($row['username'] == $_SESSION['username_foodienow']) ? 'disabled' : '' ; ?>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_delete_user.php"
                                ...
                                <div class="col-lg-12">
                                    <?php
                                        if ($row['username'] == $_SESSION['username_foodienow']) {
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-danger" name="input_user_validate"
                                        value="12345"
                                        <?php echo ($row['username'] == $_SESSION['username_foodienow']) ? 'disabled' : ''; ?>>Hapus</button>
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <form class="needs-validation" novalidate action="proses/proses_reset_password.php"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-success" name="input_user_validate"
                                        value="12345"
                                        <?php echo ($row['username'] == $_SESSION['username_foodienow']) ? 'disabled' : ''; ?>>Reset
                                        Password</button>
                                </div>
                            </form>
                        </div>
