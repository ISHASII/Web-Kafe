        ...
        <div class="card-body">
            <div class="row">
                <div class="col d-flex justify-content-end">
                    <button class="btn custom-tambah-button" data-bs-toggle="modal" data-bs-target="#ModalTambahUser"> Tambah
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_input_katmenu.php"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn custom-tambah-button" name="input_katmenu_validate"
