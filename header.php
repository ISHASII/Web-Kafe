...
?>
<nav class="navbar navbar-expand navbar-dark custom-navbar-color sticky-top">
    <div class="container-lg">
        <a class="navbar-brand" href=".">
            <img src="assets/img/Logo/logo.png" style="height: 50px; width:auto;" alt="Logo">
            FoodieNow</a>
            ...
            <div class="modal-body">
                <form class="needs-validation" novalidate action="proses/proses_ubah_password.php" method="POST">
                        ...
                        <div class="col-lg-6">
                            <div class="form-floating mb-3">
                                <input disabled type="email" class="form-control" id="floatingInput"
                                    ...
                                    value="<?php echo $_SESSION['username_foodienow'] ?>">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn custom-cancel-button" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn custom-order-button" name="ubah_password_validate" value="12345">Save
                            changes</button>
                    </div>
                </form>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="needs-validation" novalidate action="proses/proses_ubah_profile.php" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn custom-cancel-button" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn custom-order-button" name="ubah_profile_validate" value="12345">Save
                            changes</button>
                    </div>
                </form>
            </div>
